...
ActiveRecord::Schema.define(version: 2022_04_02_022210) do
  ...
  create_table "employment_types", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
  ...
  create_table "letters", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "request_id"
    t.integer "doc_template_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["request_id"], name: "index_letters_on_request_id"
  end
