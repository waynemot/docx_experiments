class EmploymentTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @employment_type.save
        format.html { redirect_to employment_type_url(@employment_type), notice: "Employment type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @employment_type.update(employment_type_params)
        format.html { redirect_to employment_type_url(@employment_type), notice: "Employment type was successfully updated." }
  ...
  private
    ...
    def employment_type_params
      params.require(:employment_type).permit(:name, :salary)
    end
end
